# ResourceDef → HAS_RESOURCE_STATUS_MODEL → ResourceStatusModel
...
- 物理外键：`[ResourceDef].[ResourceStatusModelId]`
...
- 本体关系：`ResourceDef --[HAS_RESOURCE_STATUS_MODEL]--> ResourceStatusModel`
- 基数：`MANY_TO_ONE`
- 物理定义：`ResourceDef.ResourceStatusModelId`
