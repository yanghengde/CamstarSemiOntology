# ProcessModelTemplate → HAS_ASSIGNEE_ROLE → RoleDef
...
- 物理外键：`[ProcessModelTemplate].[AssigneeRoleId]`
...
- 本体关系：`ProcessModelTemplate --[HAS_ASSIGNEE_ROLE]--> RoleDef`
- 基数：`MANY_TO_ONE`
- 物理定义：`ProcessModelTemplate.AssigneeRoleId`
