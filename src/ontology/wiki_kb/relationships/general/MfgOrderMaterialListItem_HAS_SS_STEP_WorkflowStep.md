# MfgOrderMaterialListItem → HAS_SS_STEP → WorkflowStep
...
- 物理外键：`[MfgOrderMaterialListItem].[ss_StepId]`
...
- 本体关系：`MfgOrderMaterialListItem --[HAS_SS_STEP]--> WorkflowStep`
- 基数：`MANY_TO_ONE`
- 物理定义：`MfgOrderMaterialListItem.ss_StepId`
