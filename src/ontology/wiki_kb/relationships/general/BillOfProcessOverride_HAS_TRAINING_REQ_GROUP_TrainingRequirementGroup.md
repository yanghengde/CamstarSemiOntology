# BillOfProcessOverride → HAS_TRAINING_REQ_GROUP → TrainingRequirementGroup
...
- 物理外键：`[BillOfProcessOverride].[TrainingReqGroupId]`
...
- 本体关系：`BillOfProcessOverride --[HAS_TRAINING_REQ_GROUP]--> TrainingRequirementGroup`
- 基数：`MANY_TO_ONE`
- 物理定义：`BillOfProcessOverride.TrainingReqGroupId`
