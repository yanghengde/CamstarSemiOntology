# ChecklistEntry → HAS_LAST_COMPLETED_BY → Employee
...
- 物理外键：`[ChecklistEntry].[LastCompletedById]`
...
- 本体关系：`ChecklistEntry --[HAS_LAST_COMPLETED_BY]--> Employee`
- 基数：`MANY_TO_ONE`
- 物理定义：`ChecklistEntry.LastCompletedById`
