# TrainingPlanDetail → HAS_TRAINING_PLAN → TrainingPlan
...
- 物理外键：`[TrainingPlanDetail].[TrainingPlanId]`
...
- 本体关系：`TrainingPlanDetail --[HAS_TRAINING_PLAN]--> TrainingPlan`
- 基数：`MANY_TO_ONE`
- 物理定义：`TrainingPlanDetail.TrainingPlanId`
