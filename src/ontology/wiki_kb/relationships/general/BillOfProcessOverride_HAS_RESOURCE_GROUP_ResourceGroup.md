# BillOfProcessOverride → HAS_RESOURCE_GROUP → ResourceGroup
...
- 物理外键：`[BillOfProcessOverride].[ResourceGroupId]`
...
- 本体关系：`BillOfProcessOverride --[HAS_RESOURCE_GROUP]--> ResourceGroup`
- 基数：`MANY_TO_ONE`
- 物理定义：`BillOfProcessOverride.ResourceGroupId`
