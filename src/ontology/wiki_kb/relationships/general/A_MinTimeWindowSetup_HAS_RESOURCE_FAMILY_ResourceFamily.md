# A_MinTimeWindowSetup → HAS_RESOURCE_FAMILY → ResourceFamily
...
- 物理外键：`[A_MinTimeWindowSetup].[ResourceFamilyId]`
...
- 本体关系：`A_MinTimeWindowSetup --[HAS_RESOURCE_FAMILY]--> ResourceFamily`
- 基数：`MANY_TO_ONE`
- 物理定义：`A_MinTimeWindowSetup.ResourceFamilyId`
