# SampleTest → HAS_SUB_CLASSIFICATION → SubClassification
...
- 物理外键：`[SampleTest].[SubClassificationId]`
...
- 本体关系：`SampleTest --[HAS_SUB_CLASSIFICATION]--> SubClassification`
- 基数：`MANY_TO_ONE`
- 物理定义：`SampleTest.SubClassificationId`
