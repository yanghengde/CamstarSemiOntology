# CAPA → HAS_SUB_CLASSIFICATION → SubClassification
...
- 本体关系：`CAPA --[HAS_SUB_CLASSIFICATION]--> SubClassification`
- 基数：`MANY_TO_ONE`
- 物理定义：`CAPA.SubClassificationId`
- 源表主键：`CAPA.CAPAId`
