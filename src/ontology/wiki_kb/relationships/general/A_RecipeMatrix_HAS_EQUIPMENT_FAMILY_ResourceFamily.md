# A_RecipeMatrix → HAS_EQUIPMENT_FAMILY → ResourceFamily
...
- 物理外键：`[A_RecipeMatrix].[EquipmentFamilyId]`
...
- 本体关系：`A_RecipeMatrix --[HAS_EQUIPMENT_FAMILY]--> ResourceFamily`
- 基数：`MANY_TO_ONE`
- 物理定义：`A_RecipeMatrix.EquipmentFamilyId`
