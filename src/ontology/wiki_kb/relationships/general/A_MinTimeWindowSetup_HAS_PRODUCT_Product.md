# A_MinTimeWindowSetup → HAS_PRODUCT → Product
...
- 物理外键：`[A_MinTimeWindowSetup].[ProductId]`
...
- 本体关系：`A_MinTimeWindowSetup --[HAS_PRODUCT]--> Product`
- 基数：`MANY_TO_ONE`
- 物理定义：`A_MinTimeWindowSetup.ProductId`
