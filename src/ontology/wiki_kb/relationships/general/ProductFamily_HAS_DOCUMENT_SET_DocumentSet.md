# ProductFamily → HAS_DOCUMENT_SET → DocumentSet
...
- 物理外键：`[ProductFamily].[DocumentSetId]`
...
- 本体关系：`ProductFamily --[HAS_DOCUMENT_SET]--> DocumentSet`
- 基数：`MANY_TO_ONE`
- 物理定义：`ProductFamily.DocumentSetId`
