# scsSchedulingMatrix → HAS_SCS_PROCESS_TYPE → A_ProcessType
...
- 物理外键：`[scsSchedulingMatrix].[scsProcessTypeId]`
...
- 本体关系：`scsSchedulingMatrix --[HAS_SCS_PROCESS_TYPE]--> A_ProcessType`
- 基数：`MANY_TO_ONE`
- 物理定义：`scsSchedulingMatrix.scsProcessTypeId`
