# A_MaxTimeWindowSetup → HAS_HOLD_REASON → HoldReason
...
- 物理外键：`[A_MaxTimeWindowSetup].[HoldReasonId]`
...
- 本体关系：`A_MaxTimeWindowSetup --[HAS_HOLD_REASON]--> HoldReason`
- 基数：`MANY_TO_ONE`
- 物理定义：`A_MaxTimeWindowSetup.HoldReasonId`
