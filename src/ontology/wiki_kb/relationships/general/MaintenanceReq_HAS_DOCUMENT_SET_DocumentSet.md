# MaintenanceReq → HAS_DOCUMENT_SET → DocumentSet
...
- 物理外键：`[MaintenanceReq].[DocumentSetId]`
...
- 本体关系：`MaintenanceReq --[HAS_DOCUMENT_SET]--> DocumentSet`
- 基数：`MANY_TO_ONE`
- 物理定义：`MaintenanceReq.DocumentSetId`
