# ResourceDef → HAS_TRAINING_REQ_GROUP → TrainingRequirementGroup
...
- 物理外键：`[ResourceDef].[TrainingReqGroupId]`
...
- 本体关系：`ResourceDef --[HAS_TRAINING_REQ_GROUP]--> TrainingRequirementGroup`
- 基数：`MANY_TO_ONE`
- 物理定义：`ResourceDef.TrainingReqGroupId`
