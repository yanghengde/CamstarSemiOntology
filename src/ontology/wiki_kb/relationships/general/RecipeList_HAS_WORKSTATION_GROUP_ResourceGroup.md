# RecipeList → HAS_WORKSTATION_GROUP → ResourceGroup
...
- 物理外键：`[RecipeList].[WorkstationGroupId]`
...
- 本体关系：`RecipeList --[HAS_WORKSTATION_GROUP]--> ResourceGroup`
- 基数：`MANY_TO_ONE`
- 物理定义：`RecipeList.WorkstationGroupId`
