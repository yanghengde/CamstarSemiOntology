# BizRuleParameter → HAS_BUSINESS_RULE_HANDLER → BusinessRuleHandler
...
- 物理外键：`[BizRuleParameter].[BusinessRuleHandlerId]`
...
- 本体关系：`BizRuleParameter --[HAS_BUSINESS_RULE_HANDLER]--> BusinessRuleHandler`
- 基数：`MANY_TO_ONE`
- 物理定义：`BizRuleParameter.BusinessRuleHandlerId`
