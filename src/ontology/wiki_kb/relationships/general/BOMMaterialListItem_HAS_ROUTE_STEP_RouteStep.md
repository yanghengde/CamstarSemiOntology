# BOMMaterialListItem → HAS_ROUTE_STEP → RouteStep
...
- 物理外键：`[BOMMaterialListItem].[RouteStepId]`
...
- 本体关系：`BOMMaterialListItem --[HAS_ROUTE_STEP]--> RouteStep`
- 基数：`MANY_TO_ONE`
- 物理定义：`BOMMaterialListItem.RouteStepId`
