# NonconformanceReport → HAS_ATTACHMENTS → DocAttachments
...
- 物理外键：`[NonconformanceReport].[AttachmentsId]`
...
- 本体关系：`NonconformanceReport --[HAS_ATTACHMENTS]--> DocAttachments`
- 基数：`MANY_TO_ONE`
- 物理定义：`NonconformanceReport.AttachmentsId`
