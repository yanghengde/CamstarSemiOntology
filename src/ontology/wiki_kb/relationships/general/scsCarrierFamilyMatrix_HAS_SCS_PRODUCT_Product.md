# scsCarrierFamilyMatrix → HAS_SCS_PRODUCT → Product
...
- 物理外键：`[scsCarrierFamilyMatrix].[scsProductId]`
...
- 本体关系：`scsCarrierFamilyMatrix --[HAS_SCS_PRODUCT]--> Product`
- 基数：`MANY_TO_ONE`
- 物理定义：`scsCarrierFamilyMatrix.scsProductId`
