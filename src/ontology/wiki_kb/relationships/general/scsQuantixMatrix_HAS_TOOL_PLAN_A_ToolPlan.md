# scsQuantixMatrix → HAS_TOOL_PLAN → A_ToolPlan
...
- 物理外键：`[scsQuantixMatrix].[ToolPlanId]`
...
- 本体关系：`scsQuantixMatrix --[HAS_TOOL_PLAN]--> A_ToolPlan`
- 基数：`MANY_TO_ONE`
- 物理定义：`scsQuantixMatrix.ToolPlanId`
