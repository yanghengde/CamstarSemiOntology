# A_SPCSetupDetails → HAS_SPC_SETUP → A_SPCSetup
...
- 物理外键：`[A_SPCSetupDetails].[SPCSetupId]`
...
- 本体关系：`A_SPCSetupDetails --[HAS_SPC_SETUP]--> A_SPCSetup`
- 基数：`MANY_TO_ONE`
- 物理定义：`A_SPCSetupDetails.SPCSetupId`
