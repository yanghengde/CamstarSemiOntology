# A_RunNumberSetupData → HAS_PROCESS_TYPE → A_ProcessType
...
- 物理外键：`[A_RunNumberSetupData].[ProcessTypeId]`
...
- 本体关系：`A_RunNumberSetupData --[HAS_PROCESS_TYPE]--> A_ProcessType`
- 基数：`MANY_TO_ONE`
- 物理定义：`A_RunNumberSetupData.ProcessTypeId`
