# Event → HAS_SUB_CLASSIFICATION → SubClassification
...
- 物理外键：`[Event].[SubClassificationId]`
...
- 本体关系：`Event --[HAS_SUB_CLASSIFICATION]--> SubClassification`
- 基数：`MANY_TO_ONE`
- 物理定义：`Event.SubClassificationId`
- 源表主键：`Event.EventId`
