# A_ExperimentPlanDetails → HAS_AUTOMATION_PLAN → A_AutomationPlan
...
- 物理外键：`[A_ExperimentPlanDetails].[AutomationPlanId]`
...
- 本体关系：`A_ExperimentPlanDetails --[HAS_AUTOMATION_PLAN]--> A_AutomationPlan`
- 基数：`MANY_TO_ONE`
- 物理定义：`A_ExperimentPlanDetails.AutomationPlanId`
