# BillOfProcessOverride → HAS_ELECTRONIC_PROCEDURE → ElectronicProcedure
...
- 物理外键：`[BillOfProcessOverride].[ElectronicProcedureId]`
...
- 本体关系：`BillOfProcessOverride --[HAS_ELECTRONIC_PROCEDURE]--> ElectronicProcedure`
- 基数：`MANY_TO_ONE`
- 物理定义：`BillOfProcessOverride.ElectronicProcedureId`
