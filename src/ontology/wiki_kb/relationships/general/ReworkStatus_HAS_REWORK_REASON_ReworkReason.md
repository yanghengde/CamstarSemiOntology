# ReworkStatus → HAS_REWORK_REASON → ReworkReason
...
- 物理外键：`[ReworkStatus].[ReworkReasonId]`
...
- 本体关系：`ReworkStatus --[HAS_REWORK_REASON]--> ReworkReason`
- 基数：`MANY_TO_ONE`
- 物理定义：`ReworkStatus.ReworkReasonId`
