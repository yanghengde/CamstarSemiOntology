# A_ProcessSpecDetails → HAS_DOCUMENT_SET → DocumentSet
...
- 物理外键：`[A_ProcessSpecDetails].[DocumentSetId]`
...
- 本体关系：`A_ProcessSpecDetails --[HAS_DOCUMENT_SET]--> DocumentSet`
- 基数：`MANY_TO_ONE`
- 物理定义：`A_ProcessSpecDetails.DocumentSetId`
