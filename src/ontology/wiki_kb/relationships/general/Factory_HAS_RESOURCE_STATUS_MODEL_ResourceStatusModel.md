# Factory → HAS_RESOURCE_STATUS_MODEL → ResourceStatusModel
...
- 物理外键：`[Factory].[ResourceStatusModelId]`
...
- 本体关系：`Factory --[HAS_RESOURCE_STATUS_MODEL]--> ResourceStatusModel`
- 基数：`MANY_TO_ONE`
- 物理定义：`Factory.ResourceStatusModelId`
