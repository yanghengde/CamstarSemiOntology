# A_RunNumberSetupData → HAS_PROCESS_SPEC → A_ProcessSpec
...
- 物理外键：`[A_RunNumberSetupData].[ProcessSpecId]`
...
- 本体关系：`A_RunNumberSetupData --[HAS_PROCESS_SPEC]--> A_ProcessSpec`
- 基数：`MANY_TO_ONE`
- 物理定义：`A_RunNumberSetupData.ProcessSpecId`
