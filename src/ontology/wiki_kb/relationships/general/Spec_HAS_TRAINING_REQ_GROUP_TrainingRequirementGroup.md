# Spec → HAS_TRAINING_REQ_GROUP → TrainingRequirementGroup
...
- 本体关系：`Spec --[HAS_TRAINING_REQ_GROUP]--> TrainingRequirementGroup`
- 基数：`MANY_TO_ONE`
- 物理定义：`Spec.TrainingReqGroupId`
- 源表主键：`Spec.SpecId`
