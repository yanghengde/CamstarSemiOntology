# Operation → HAS_TRAINING_REQ_GROUP → TrainingRequirementGroup
...
- 物理外键：`[Operation].[TrainingReqGroupId]`
...
- 本体关系：`Operation --[HAS_TRAINING_REQ_GROUP]--> TrainingRequirementGroup`
- 基数：`MANY_TO_ONE`
- 物理定义：`Operation.TrainingReqGroupId`
