# Spec → HAS_EXTERNAL_INTERFACE → A_ExternalInterface
...
- 本体关系：`Spec --[HAS_EXTERNAL_INTERFACE]--> A_ExternalInterface`
- 基数：`MANY_TO_ONE`
- 物理定义：`Spec.ExternalInterfaceId`
- 源表主键：`Spec.SpecId`
