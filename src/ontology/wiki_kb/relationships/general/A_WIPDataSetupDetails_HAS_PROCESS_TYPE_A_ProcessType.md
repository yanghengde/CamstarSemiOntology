# A_WIPDataSetupDetails → HAS_PROCESS_TYPE → A_ProcessType
...
- 物理外键：`[A_WIPDataSetupDetails].[ProcessTypeId]`
...
- 本体关系：`A_WIPDataSetupDetails --[HAS_PROCESS_TYPE]--> A_ProcessType`
- 基数：`MANY_TO_ONE`
- 物理定义：`A_WIPDataSetupDetails.ProcessTypeId`
