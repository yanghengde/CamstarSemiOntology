# A_SPCSetupDetails → HAS_SPC_RULES → A_SPCRules
...
- 物理外键：`[A_SPCSetupDetails].[SPCRulesId]`
...
- 本体关系：`A_SPCSetupDetails --[HAS_SPC_RULES]--> A_SPCRules`
- 基数：`MANY_TO_ONE`
- 物理定义：`A_SPCSetupDetails.SPCRulesId`
