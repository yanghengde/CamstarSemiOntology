# Event → HAS_QUALITY_RESOLUTION_CODE → QualityResolutionCode
...
- 物理外键：`[Event].[QualityResolutionCodeId]`
...
- 本体关系：`Event --[HAS_QUALITY_RESOLUTION_CODE]--> QualityResolutionCode`
- 基数：`MANY_TO_ONE`
- 物理定义：`Event.QualityResolutionCodeId`
- 源表主键：`Event.EventId`
