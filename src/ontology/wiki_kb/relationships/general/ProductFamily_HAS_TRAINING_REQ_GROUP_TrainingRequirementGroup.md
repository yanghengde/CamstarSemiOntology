# ProductFamily → HAS_TRAINING_REQ_GROUP → TrainingRequirementGroup
...
- 物理外键：`[ProductFamily].[TrainingReqGroupId]`
...
- 本体关系：`ProductFamily --[HAS_TRAINING_REQ_GROUP]--> TrainingRequirementGroup`
- 基数：`MANY_TO_ONE`
- 物理定义：`ProductFamily.TrainingReqGroupId`
