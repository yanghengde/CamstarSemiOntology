# A_WIPDataSetup → HAS_SUB_CLASSIFICATION → SubClassification
...
- 物理外键：`[A_WIPDataSetup].[SubClassificationId]`
...
- 本体关系：`A_WIPDataSetup --[HAS_SUB_CLASSIFICATION]--> SubClassification`
- 基数：`MANY_TO_ONE`
- 物理定义：`A_WIPDataSetup.SubClassificationId`
