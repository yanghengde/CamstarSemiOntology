# scsCarrierFamilyMatrix → HAS_SCS_PROCESS_SPEC → A_ProcessSpec
...
- 物理外键：`[scsCarrierFamilyMatrix].[scsProcessSpecId]`
...
- 本体关系：`scsCarrierFamilyMatrix --[HAS_SCS_PROCESS_SPEC]--> A_ProcessSpec`
- 基数：`MANY_TO_ONE`
- 物理定义：`scsCarrierFamilyMatrix.scsProcessSpecId`
