# scsQuantixMatrix → HAS_PROCESS_SPEC → A_ProcessSpec
...
- 物理外键：`[scsQuantixMatrix].[ProcessSpecId]`
...
- 本体关系：`scsQuantixMatrix --[HAS_PROCESS_SPEC]--> A_ProcessSpec`
- 基数：`MANY_TO_ONE`
- 物理定义：`scsQuantixMatrix.ProcessSpecId`
