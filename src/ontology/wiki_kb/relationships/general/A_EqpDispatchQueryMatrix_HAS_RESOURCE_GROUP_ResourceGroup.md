# A_EqpDispatchQueryMatrix → HAS_RESOURCE_GROUP → ResourceGroup
...
- 物理外键：`[A_EqpDispatchQueryMatrix].[ResourceGroupId]`
...
- 本体关系：`A_EqpDispatchQueryMatrix --[HAS_RESOURCE_GROUP]--> ResourceGroup`
- 基数：`MANY_TO_ONE`
- 物理定义：`A_EqpDispatchQueryMatrix.ResourceGroupId`
