# MfgOrderMaterialListItem → HAS_ROUTE_STEP → RouteStep
...
- 物理外键：`[MfgOrderMaterialListItem].[RouteStepId]`
...
- 本体关系：`MfgOrderMaterialListItem --[HAS_ROUTE_STEP]--> RouteStep`
- 基数：`MANY_TO_ONE`
- 物理定义：`MfgOrderMaterialListItem.RouteStepId`
