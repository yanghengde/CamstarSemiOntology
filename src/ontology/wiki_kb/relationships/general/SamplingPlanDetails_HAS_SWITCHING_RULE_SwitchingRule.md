# SamplingPlanDetails → HAS_SWITCHING_RULE → SwitchingRule
...
- 物理外键：`[SamplingPlanDetails].[SwitchingRuleId]`
...
- 本体关系：`SamplingPlanDetails --[HAS_SWITCHING_RULE]--> SwitchingRule`
- 基数：`MANY_TO_ONE`
- 物理定义：`SamplingPlanDetails.SwitchingRuleId`
