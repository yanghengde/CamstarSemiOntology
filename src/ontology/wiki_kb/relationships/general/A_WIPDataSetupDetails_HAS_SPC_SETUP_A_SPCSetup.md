# A_WIPDataSetupDetails → HAS_SPC_SETUP → A_SPCSetup
...
- 物理外键：`[A_WIPDataSetupDetails].[SPCSetupId]`
...
- 本体关系：`A_WIPDataSetupDetails --[HAS_SPC_SETUP]--> A_SPCSetup`
- 基数：`MANY_TO_ONE`
- 物理定义：`A_WIPDataSetupDetails.SPCSetupId`
