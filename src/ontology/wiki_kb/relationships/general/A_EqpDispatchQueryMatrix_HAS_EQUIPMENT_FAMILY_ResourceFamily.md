# A_EqpDispatchQueryMatrix → HAS_EQUIPMENT_FAMILY → ResourceFamily
...
- 物理外键：`[A_EqpDispatchQueryMatrix].[EquipmentFamilyId]`
...
- 本体关系：`A_EqpDispatchQueryMatrix --[HAS_EQUIPMENT_FAMILY]--> ResourceFamily`
- 基数：`MANY_TO_ONE`
- 物理定义：`A_EqpDispatchQueryMatrix.EquipmentFamilyId`
