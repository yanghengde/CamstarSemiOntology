# Enterprise → HAS_TRAINING_REQ_GROUP → TrainingRequirementGroup
...
- 物理外键：`[Enterprise].[TrainingReqGroupId]`
...
- 本体关系：`Enterprise --[HAS_TRAINING_REQ_GROUP]--> TrainingRequirementGroup`
- 基数：`MANY_TO_ONE`
- 物理定义：`Enterprise.TrainingReqGroupId`
