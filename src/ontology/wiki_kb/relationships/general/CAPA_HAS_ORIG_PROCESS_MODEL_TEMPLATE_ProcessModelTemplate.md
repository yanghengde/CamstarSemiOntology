# CAPA → HAS_ORIG_PROCESS_MODEL_TEMPLATE → ProcessModelTemplate
...
- 物理外键：`[CAPA].[OrigProcessModelTemplateId]`
...
- 本体关系：`CAPA --[HAS_ORIG_PROCESS_MODEL_TEMPLATE]--> ProcessModelTemplate`
- 基数：`MANY_TO_ONE`
- 物理定义：`CAPA.OrigProcessModelTemplateId`
- 源表主键：`CAPA.CAPAId`
