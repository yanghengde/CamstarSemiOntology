# ProcessModel → HAS_ATTACHMENTS → DocAttachments
...
- 物理外键：`[ProcessModel].[AttachmentsId]`
...
- 本体关系：`ProcessModel --[HAS_ATTACHMENTS]--> DocAttachments`
- 基数：`MANY_TO_ONE`
- 物理定义：`ProcessModel.AttachmentsId`
