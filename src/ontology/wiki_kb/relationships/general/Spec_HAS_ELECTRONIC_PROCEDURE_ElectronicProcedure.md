# Spec → HAS_ELECTRONIC_PROCEDURE → ElectronicProcedure
...
- 物理外键：`[Spec].[ElectronicProcedureId]`
...
- 本体关系：`Spec --[HAS_ELECTRONIC_PROCEDURE]--> ElectronicProcedure`
- 基数：`MANY_TO_ONE`
- 物理定义：`Spec.ElectronicProcedureId`
- 源表主键：`Spec.SpecId`
