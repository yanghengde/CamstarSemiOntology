# ResourceDef → HAS_MASK → ResourceDef
...
- JOIN 条件：`src.[MaskId] = tgt.[ResourceId]`
- 物理外键：`[ResourceDef].[MaskId]`
...
- 本体关系：`ResourceDef --[HAS_MASK]--> ResourceDef`
- 基数：`MANY_TO_ONE`
- 物理定义：`ResourceDef.MaskId`
