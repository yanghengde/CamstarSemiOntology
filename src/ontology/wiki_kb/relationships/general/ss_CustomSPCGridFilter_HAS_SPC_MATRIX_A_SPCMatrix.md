# ss_CustomSPCGridFilter → HAS_SPC_MATRIX → A_SPCMatrix
...
- 物理外键：`[ss_CustomSPCGridFilter].[SPCMatrixId]`
...
- 本体关系：`ss_CustomSPCGridFilter --[HAS_SPC_MATRIX]--> A_SPCMatrix`
- 基数：`MANY_TO_ONE`
- 物理定义：`ss_CustomSPCGridFilter.SPCMatrixId`
